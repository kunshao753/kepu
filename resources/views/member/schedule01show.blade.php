            ...
            <ul class="form-list">
                    @foreach ($signupResouce as $key=>$value)
                        <li class="clearfix">
                            ...
                            @if ($key < 4)
                                <input type="text" @if($key == $cropInfo->signup_resouce) value="{{$cropInfo->signup_resouce_val}}" @else disabled   @endif  name="signup_resouce_{{$key}}" maxlength="49" placeholder="{{$value['tips']}}" class="signup_resouce_{{$key}} input-box">
                            @endif
                            @if($key == 1)
        ...
        <div class="form-schedule w">
            ...
            <ul class="form-list">
                <li class="clearfix">
                    ...
                    <input type="text" name="name" value="{{$cropInfo->name}}" maxlength="8" id="name" placeholder="请填写姓名" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <div class="radio-list">
                        <div class="label">
                            <input name="sex" id="sex"  @if(1 == $cropInfo->sex) checked @endif checked value="1" type="radio">
                            <label for="">男</label>
                        </div>
                        <div class="label">
                            <input name="sex" id="sex1" @if(2 == $cropInfo->sex) checked @endif value="2" type="radio">
                            <label for="">女</label>
                        </div>
                    </div>
                </li>
                <li class="clearfix">
                    ...
                    <input type="text" name="birthday"  value="{{$dateInput['birthday']}}"  id="birthday" placeholder="请填写出生年月,格式:月/日/年" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="age" id="age"  value="{{$cropInfo->age}}" placeholder="请填写年龄" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="identity_no" value="{{$cropInfo->identity_no}}"  maxlength="18" id="identity_no" placeholder="请填写身份证号" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="mobile" value="{{$cropInfo->mobile}}" maxlength="11" id="mobile" placeholder="请填手机号" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="wechat" maxlength="29" value="{{$cropInfo->wechat}}" placeholder="请填写微信号" class="input-box">
                </li>
                <li class="clearfix">
                    <div class="label">
                        <label for="">邮箱</label>
                    </div>
                    <input type="text" name="email" maxlength="39" value="{{$cropInfo->email}}" id="email" placeholder="请填写邮箱" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <div class="label">
                        <input value="1" name="contestant_identity"  @if(1 == $cropInfo->contestant_identity) checked @endif  id="contestant_identity" type="radio">
                        <label for="">企业</label>
                    </div>
                    <div class="label">
                        <input value="2" name="contestant_identity"  @if(2 == $cropInfo->contestant_identity) checked @endif id="contestant_identity1" type="radio">
        ...
        <div class="form-schedule w">
            ...
            <ul class="form-list">
                <li class="clearfix">
                    ...
                    <input type="text" maxlength="49" value="{{$cropInfo->company_name}}"  name="company_name" id="company_name" placeholder="请填写企业名称" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="website_url" value="{{$cropInfo->website_url}}" maxlength="95" placeholder="请填写企业网址" class="input-box">
                </li>
            </ul>
        </div>
        <div class="form-schedule w">
                ...
                <ul class="form-list">
                    <li class="clearfix">
                        ...
                        <input type="text" maxlength="18" value="{{$cropInfo->organization_code}}"   name="organization_code" id="organization_code" placeholder="请填写统一社会信用代码" class="input-box">
                    ...
                    <li class="clearfix">
                        ...
                        <input type="text" maxlength="8" name="company_legal_name" id="company_legal_name" value="{{$cropInfo->company_legal_name}}" placeholder="请填写法定代表人姓名" class="input-box">
                    ...
                    <li class="clearfix">
                        ...
                        <input type="text" value="{{$cropInfo->registered_capital}}"  name="registered_capital" maxlength="8" id="registered_capital" placeholder="请填写注册资本" class="input-box">
                    ...
                    <li class="clearfix cur">
                        ...
                        <div class="select-box clearfix">
                            <input type="text" name="registered_address" maxlength="49" value="{{$cropInfo->registered_address}}"  id="registered_address"  placeholder="请选择注册地区" class="input-box">
