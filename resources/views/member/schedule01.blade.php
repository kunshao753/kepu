            ...
            <ul class="form-list">
                @foreach ($signupResouce as $key=>$value)
                    <li class="clearfix">
                        ...
                        @if ($key < 4)
                            <input type="text" name="signup_resouce_{{$key}}" placeholder="{{$value['tips']}}" class="input-box">
                        @endif
                        @if($key == 1)
        ...
        <div class="form-schedule w">
            ...
            <ul class="form-list">
                <li class="clearfix">
                    ...
                    <input type="text" name="name" id="name" placeholder="请填写姓名" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="identity_no" id="identity_no" placeholder="请填写身份证号" class="input-box">
                ...
                <li class="clearfix">
                    ...
                    <input type="text" name="mobile" id="mobile" placeholder="请填手机号" class="input-box">
        ...
        <div class="form-schedule w">
            ...
            <ul class="form-list">
                <li class="clearfix">
                    ...
                    <input type="text" name="company_name" id="company_name" placeholder="请填写企业名称" class="input-box">
        ...
        <div class="form-schedule w">
                ...
                <ul class="form-list">
                    <li class="clearfix">
                        ...
                        <input type="text"  name="organization_code" id="organization_code" placeholder="请填写统一社会信用代码" class="input-box">
                    ...
                    <li class="clearfix">
                        ...
                        <input type="text" name="company_legal_name" id="company_legal_name" placeholder="请填写法定代表人姓名" class="input-box">
                    ...
                    <li class="clearfix">
                        ...
                        <input type="text" name="registered_capital" id="registered_capital" placeholder="请填写注册资本" class="input-box">
                    ...
                    <li class="clearfix cur">
                        ...
                        <div class="select-box clearfix">
                            <input type="text" name="registered_address" id="registered_address"  placeholder="请选择注册地区" class="input-box">
