    ...
    <div class="form-schedule w">
        ...
        <ul class="form-list">
            <li class="clearfix">
                ...
                <input type="text" name="team_size" value="{{$teamInfo->team_size}}" maxlength="5" id="team_size" placeholder="请填写团队人数" class="input-box">
            ...
            <li class="clearfix">
                ...
                <textarea name="our_team" id="our_team" placeholder="请填写团队概况" class="textarea-box">{{$teamInfo->our_team}}</textarea>
            ...
            <li class="clearfix">
                ...
                <textarea name="member_profile" id="member_profile" placeholder="请填写姓名、背景、职能等" class="textarea-box">{{$teamInfo->member_profile}}</textarea>
            ...
            <li class="clearfix">
                ...
                <textarea name="management_system_list" id="management_system_list" placeholder="请填管理制度" class="textarea-box">{{$teamInfo->management_system_list}}</textarea>
